...
export default function Course ({match}) {
    ...
    return (<div className= {classes.root}>
        <Card className= {classes.card}>
                        ...
                        (<span className= {classes.action}>
                            ...
                            {!course.published ? (<>
                                <Button color= "secondary" variant= "outlined" onClick= {clickPublish}>
                                    {course.lesson.length == 0 ? "Add at least 1 lesson to publish" : "Publish"}
                                </Button>
            ...
            <div className= {classes.flex}>
                ...
                <div className= {classes.details}>
                    ...
                    {
                        course.published && <div className= {classes.enroll}>
        ...
        <Dialog open= {open} onClose= {handleClose} aria-labelledby= "form-dialog-title">
            ...
            <DialogContent>
                <Typography variant= "body1">Publishng your course will make it live to students for enrollment.</Typography>
